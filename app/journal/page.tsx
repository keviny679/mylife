    ...
    useEffect(() => {
        ...
        audioRef.current = new Audio('i gvae it my all.mp3')
    ...
    return (
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 py-10">
            ...
            style={{
                ...
                color: rainPlaying ? t.accent : t.textFaint,
                background: t.entryBg, border: `1px solid ${t.entryBorder}`,
                borderRadius: '20px', padding: '6px 14px', cursor: 'pointer', margin: '0 auto 1.5rem',
                transition: 'color 0.2s ease'
            }}
            >
            ...
            <div className="flex flex-col gap-4">
                ...
                <div
                    ...
                    style={{ background: t.entryBg, border: `1px solid ${t.entryBorder}`, cursor: 'pointer' }}
